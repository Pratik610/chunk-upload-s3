    ...
    <div className="w-full" {...getRootProps()}>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="relative mx-auto dark mt-10 w-full max-w-xl">
            {files.length > 0 &&
              files.map((file, idx) => (
                <motion.div
                  key={"file" + idx}
                ...
                >
                  <div className="flex w-full items-center justify-between gap-4">
                    <motion.p
                      ...
                      animate={{ opacity: 1 }}
                      layout
                      className="max-w-xs min-w-xs truncate text-base text-neutral-700 dark:text-neutral-300"
                    >
                      {file.name}
                    </motion.p>
                    <motion.p
          ...
          <p className="relative z-20 mt-10 font-sans text-base font-normal text-neutral-400 dark:text-neutral-400">
